        ...
        steps={[
          {
            tour: "demo",
            steps: [
              config("✏️", "What's your tweet about?", "What is the desired position, give us a context we can work with, like for example \"France, World Cup 2018\"", "#onborda-step1", "bottom"),
              ...
              config("📏", "How long do you want your tweet to be?", "Select the length of your tweet, it can be 140, 280 or more characters if you have a Twitter Premium account.", "#onborda-step4", "top"),
              ...
              config("🚀", "You're ready to tweet!", "You're ready to tweet, click on the button below to generate your tweet.", "#onborda-step8", "top"),
            ],
          },
        ]}>
          {children}
